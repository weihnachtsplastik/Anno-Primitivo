...
public class GuiInterface extends Gui
{
	...
	{
		controlList.clear();
		GuiButton guiButton = new GuiButton(0, "/build.png", x + width - 32, 0, 32, 32, this);
		guiButton.setHoverTexture("/build_select.png");
		guiButton.setDisabledTexture("/build_disabled.png");
	...
	public void paint(Graphics g)
	{
		...
		g.drawImage(texMngr.getTexture("/money.png"), x, y, null);
		g.drawString("" + world.getWorldData().getItem(256).getAmount(), x + 34, y + 23);
		g.drawImage(texMngr.getTexture("/wood.png"), x + 96, 544, null);
		g.drawString("" + world.getWorldData().getItem(257).getAmount(), x + 130, y + 23);
		g.drawImage(texMngr.getTexture("/stone.png"), x + 192, y, null);
