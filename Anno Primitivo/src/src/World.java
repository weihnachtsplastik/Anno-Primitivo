...
public class World
{
	...
	/**
	 * Gibt den Entity Manager zur�ck.<br>
	...
	/**
	 * Gibt den Block an der angegebenen Position zur�ck.
	 * 
	 * @param x
	 *            die X-Position
	 * @param y
	...
	/**
	 * Gibt die ID des Blocks an der angegebenen Position zur�ck.
	 * 
	 * @param x
	 *            die X-Position
	 * @param y
